...
roll_calendars_from_db = os.path.join(os.sep, 'home', 'vcaldas', 'data', 'interim', 'roll_calendars_from_contracts')
source_contracts =  os.path.join(os.sep, 'home', 'vcaldas', 'data', 'parquet', 'future_contract_prices')
...
csv_multiple_data_path = os.path.join(os.sep, 'home', 'vcaldas', 'data', 'interim', 'multiple_prices_csv')
if not os.path.exists(csv_multiple_data_path):
    os.makedirs(csv_multiple_data_path)
    
multiple_prices_from_db = os.path.join(os.sep, 'home', 'vcaldas', 'data', 'interim', 'multiple_from_db')
...
spliced_multiple_prices = os.path.join(os.sep, 'home', 'vcaldas', 'data', 'interim', 'multiple_prices_csv_spliced')
...
csv_adj_data_path = os.path.join(os.sep, 'home', 'vcaldas', 'data', 'futures', 'futures_adjusted_prices')
...
spliced = pd.concat([supplied, generated])
roll_calendars_folder = os.path.join(os.sep, 'home', 'vcaldas', 'data', 'futures', 'roll_calendars_csv')
