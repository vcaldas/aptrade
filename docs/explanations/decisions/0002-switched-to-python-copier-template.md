...
The template will ensure consistency in developer environments and package
management.
...
`python-copier-template` and can pull from this template to update the packaging
