...
from polygon.websocket.models import EquityTrade, Market, WebSocketMessage
...
def run_websocket_client():
    client = WebSocketClient(
        "HqKDO6pnKQxtXuVlhjULoJv0TLrZd9bH", market=Market.Crypto
    )  # hardcoded api_key is used
    # client = WebSocketClient(os.getenv("POLYGON_API_KEY"))  # POLYGON_API_KEY environment variable is used
