...
def futures(commtype=CommInfoBase.COMM_FIXED, **kwargs):
    ...
    """
    return CommInfoBase(stocklike=False, commtype=commtype, **kwargs)
...
def futures_perc(**kwargs):
    ...
    """
    return futures(commtype=CommInfoBase.COMM_PERC, **kwargs)
...
def futures_fixed(**kwargs):
    ...
    """
    return futures(commtype=CommInfoBase.COMM_FIXED, **kwargs)
...
def stocks(commtype=CommInfoBase.COMM_PERC, **kwargs):
    ...
    """
    return CommInfoBase(stocklike=True, commtype=commtype, **kwargs)
...
def stocks_perc(**kwargs):
    ...
    """
    return stocks(commtype=CommInfoBase.COMM_PERC, **kwargs)
...
def stocks_fixed(**kwargs):
    ...
    """
    return stocks(commtype=CommInfoBase.COMM_FIXED, **kwargs)
