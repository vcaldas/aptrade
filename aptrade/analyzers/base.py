...
from aptrade.metabase import MetaParams, findowner
    ...
    def donew(cls, *args, **kwargs):
        ...
        if _obj.datas:
            ...
            for i, line in enumerate(data.lines):
                linealias = data._getlinealias(i)
                if linealias:
                    setattr(_obj, "data_%s" % linealias, line)
                setattr(_obj, "data_%d" % i, line)
            for d, data in enumerate(_obj.datas):
                ...
                for i, line in enumerate(data.lines):
                    ...
                    setattr(_obj, "data%d_%d" % (d, i), line)
...
class Analyzer(metaclass=MetaAnalyzer):
    ...
    def print(self, *args, **kwargs):
        ...
        output
        """
        from aptrade.writer import WriterFile
