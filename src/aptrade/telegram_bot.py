...
_TELEGRAM_NOTIFICATIONS_ENABLED = True


def disable_telegram_notifications() -> None:
    global _TELEGRAM_NOTIFICATIONS_ENABLED, telegram_bot
    _TELEGRAM_NOTIFICATIONS_ENABLED = False
    telegram_bot = None


def enable_telegram_notifications() -> None:
    global _TELEGRAM_NOTIFICATIONS_ENABLED
    _TELEGRAM_NOTIFICATIONS_ENABLED = True


def telegram_notifications_enabled() -> bool:
    return _TELEGRAM_NOTIFICATIONS_ENABLED
